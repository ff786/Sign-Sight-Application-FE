...
import Category2_TextToVideo from "../../../quiz/Category2_TextToVideo";
import Category3_VideoToText from "../../../quiz/Category3_VideoToText";
import Category4_SignToSign from "../../../quiz/Category4_SignToSign";
